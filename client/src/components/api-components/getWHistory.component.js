...
const getWHistory = async (appId, token, deviceName, startTime, endTime)=>{

    let res = await axios.post('/getWHistory', {
        appid:appId,
        token:token,
    ...
    return(
        <div className={classes.overlay}>
            ...
            <div>
                ...
                <button onClick={
                    ()=>{
                        getWHistory(currnet_id, currnet_token, deviceName, startTime, endTime)
